          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: AppColors.glowShadow(const Color(0xff0284C7)),
              ),
              child: Row(
                children: [
                  Container(
            ...
            // Card 1: Find Nearest Hospitals on Map
            _buildActionCard(
              icon: Icons.local_hospital_rounded,
              iconColor: Colors.white,
              iconBg: const Color(0xff0284C7),
              title: "Find Nearest Hospitals",
              subtitle: "Open GPS directions to closest emergency departments & clinics",
              badgeText: "GPS Direct",
              onTap: () async {
                try {
                  ...
                  final url = Platform.isAndroid
                      ? "https://www.google.com/maps/search/hospital/@$lat,$long,12.5z"
                      : "https://maps.apple.com/?q=hospital&sll=$lat,$long";
            ...
            // Card 2: Call Hospital Helpline
            Obx(() {
              final number = countryConfig.hospitalNumber;
            ...
            _buildActionCard(
              ...
              title: "Send Medical Alert SMS",
              subtitle: "Send urgent hospital/medical alert & GPS coordinates to your contacts",
              badgeText: "Alert",
              onTap: () {
                smsController.sendLocationViaSMS("MEDICAL EMERGENCY! Need hospital assistance at");
              },
            ),
          ],
        ),
